...
<?php foreach ($result as $row) : ?>
    <?php if ($row['status'] === 'pending' && $row['user_id'] === $user_id) : ?>
        ...
        <div class=" block w-full p-6 bg-yellow-100 border  rounded-lg    dark:bg-gray-800 dark:border-gray-700  ">
            ...
            <div class=" py-3">
          <p class="  text-semibold"><?php echo date('Y, F j, g:i A', strtotime($row['date_time_taskassign'])); ?></p>
        </div>
            <div class=" py-3">
                  ...
                  <div class="p-6 space-y-6">
                    ...
                    <form action="./Userdashboard.php" method="POST">
                      ...
                      <div class="mb-6">
                        ...
                        <input type="datetime-local" id="phdatetime updatedate_time_task_start" name="updatedate_time_task_start" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                      </div>
                      <div class="mb-6">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Start</label>
                        <input type="datetime-local" id="phdatetime updatedate_time_task_end" name="updatedate_time_task_end" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                      </div>
                      </div>
...
<div class=" grid  grid-cols-1 lg:grid-cols-3  w-full gap-4">
  ...
  <div class=" block w-full p-6 bg-green-100 border  rounded-lg    dark:bg-gray-800 dark:border-gray-700  ">
      ...
      <div class=" py-3">
          <p class="  text-semibold"><?php echo date('Y, F j, g:i A', strtotime($row['date_time_task_start'])); ?></p>
        </div>
      <div class=" py-3">
...
// Set the value of the "date_time_task_start" input field to the current date and time in PST
document.getElementById('phdatetime').value = formattedDateTimePST;
</script>
