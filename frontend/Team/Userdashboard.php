                  ...
                  <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="py-4 px-5 space-y-6">
                      ...
                      <form action="./Userdashboard.php" method="POST">
                        ...
                        <div class="flex items-center justify-end  py-3 space-x-2 border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <div class="p-6 space-y-6">
                      <form action="./Userdashboard.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                          ...
                          <input type="file" id="update_image_proof" name="update_image_proof" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div class=" mb-6">
