...
<h1 class="font-semibold text-xl">Task Assigned</h1>
<div class="py-2"></div>
      ...
      <div class="py-2"> 
      <h1 class="font-semibold text-xl">Task Ongoing</h1>
      </div>
      <div class="taskTableContainer grid  grid-cols-1 lg:grid-cols-3  w-full gap-4">
        ...
        <?php if ($row['status'] == 'ongoing') : ?>
          ...
          <div class=" taskItem  block w-full p-6 bg-green-100 border  rounded-lg    dark:bg-gray-800 dark:border-gray-700  ">
            <div class="flex justify-between gap-2 items-center">
              <div class="flex items-center gap-2">
                <?php if ($row['avatar']) : ?>
                  <img class="w-7 h-7 rounded-full" src="data:image/jpeg;base64,<?php echo base64_encode($row['avatar']); ?>" alt="User Avatar" class="rounded-full w-16 h-16">
      ...
      <div class="py-2"> 
      <h1 class="font-semibold text-xl">Task Completed</h1>
      </div>
      <div class="taskTableContainer grid  grid-cols-1 lg:grid-cols-3  w-full gap-4">
        ...
        <?php if ($row['status'] == 'completed') : ?>
          ...
          <div class=" taskItem  block w-full p-6 bg-gray-200 border  rounded-lg    dark:bg-gray-800 dark:border-gray-700  ">
            <div class="flex justify-between gap-2 items-center">
              <div class="flex items-center gap-2">
                <?php if ($row['avatar']) : ?>
                  <img class="w-7 h-7 rounded-full" src="data:image/jpeg;base64,<?php echo base64_encode($row['avatar']); ?>" alt="User Avatar" class="rounded-full w-16 h-16">
